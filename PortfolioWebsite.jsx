      ...
      <section className="relative z-10 flex flex-col lg:flex-row items-center justify-between px-8 lg:px-20 py-20 gap-12">
        <div className="max-w-2xl">
          ...
          <div className="flex gap-4 flex-wrap">
            <a
              href="#projects"
              className="px-6 py-3 rounded-2xl bg-cyan-400 text-black font-semibold hover:scale-105 transition inline-block"
            >
              View Projects
            </a>

            <a
              href="RESUME OF TANISHA...pdf"
              download
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
          {[
            ...
            >
              ...
              <button className="text-cyan-400 hover:translate-x-2 transition">
      ...
      <section id="contact" className="relative z-10 px-8 lg:px-20 py-16">
        <div className="bg-gradient-to-r from-cyan-500/10 to-purple-500/10 border border-white/10 rounded-[30px] p-10 text-center backdrop-blur-xl">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <a
              href="mailto:tanisharajoria112@gmail.com"
              className="px-6 py-3 bg-cyan-400 text-black rounded-2xl font-semibold hover:scale-105 transition"
            >
              Email Me
            </a>

            <a
              href="https://linkedin.com/in/tanisha-rajoria-aa03b7341"
              target="_blank"
